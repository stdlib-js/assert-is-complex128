...
```javascript
isComplex128 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-complex128@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-complex128@v0.1.1-umd/browser.js"></script>
```
